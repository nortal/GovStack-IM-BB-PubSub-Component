...
@ApiResponse(
    responseCode = "404",
    description = Violation.MANAGER_NOT_FOUND,
    content = {@Content(
        ...
        examples = @ExampleObject(
            ...
            value = "{ \"timestamp\": \"2023-08-11T15:53:57.5425895\", \"message\": \"Manager was not found\" }"
        ))}
)
public @interface ManagerNotFoundApiResponse {}
