...
@ApiResponses({
    @ApiResponse(responseCode = "200", description = "Returns 200 when a publisher is successfully terminated"),
    @ApiResponse(
        responseCode = "404",
        description = "Returns 404 when manager, room or publisher is not found",
        content = {
            @Content(
                ...
                examples = {
                    ...
                    @ExampleObject(
                        ...
                        value = "{ \"timestamp\": \"2023-08-11T15:53:57.5425895\", \"message\": \"" + PUBLISHER_NOT_FOUND + "\" }")
                })
        }),
    @ApiResponse(
        responseCode = "500",
...
public @interface TerminatePublisherOperation {
}
