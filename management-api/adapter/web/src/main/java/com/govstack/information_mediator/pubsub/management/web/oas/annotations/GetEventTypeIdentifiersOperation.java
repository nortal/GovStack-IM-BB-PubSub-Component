...
@ApiResponses({
    @ApiResponse(responseCode = "200", description = "Returns 200 and list of all event type identifiers in the active message room"),
    @ApiResponse(
        responseCode = "404",
...
public @interface GetEventTypeIdentifiersOperation {
}
