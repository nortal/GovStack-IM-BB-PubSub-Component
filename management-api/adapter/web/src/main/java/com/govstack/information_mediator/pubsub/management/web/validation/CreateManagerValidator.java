...
import com.govstack.information_mediator.pubsub.management.web.manager.CreateManagerDTO;
...
public class CreateManagerValidator implements ConstraintValidator<CreateManagerValidation, CreateManagerDTO> {

    private final SchemaProvider schemaProvider = new SchemaProvider(Path.of("create-manager-schema.json"));

    private final JsonService jsonService;

    @Override
    public boolean isValid(CreateManagerDTO value, ConstraintValidatorContext context) {
