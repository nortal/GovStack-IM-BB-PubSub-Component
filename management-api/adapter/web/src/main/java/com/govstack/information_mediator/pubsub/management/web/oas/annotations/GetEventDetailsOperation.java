...
@ApiResponses({
    @ApiResponse(responseCode = "200", description = "Returns 200 and details for the event, publisher, subscribers, deliveries."),
    @ApiResponse(
        responseCode = "404",
        description = "Returns 404 when manager, room or event is not found",
        content = {
            @Content(
                ...
                examples = {
                    ...
                    @ExampleObject(
                        name = "Room not found",
                        value = "{ \"timestamp\": \"2023-08-11T15:53:57.5425895\", \"message\": \"" + EVENT_NOT_FOUND + "\" }")
                })
        }),
    @ApiResponse(
        responseCode = "500",
...
public @interface GetEventDetailsOperation {
}
