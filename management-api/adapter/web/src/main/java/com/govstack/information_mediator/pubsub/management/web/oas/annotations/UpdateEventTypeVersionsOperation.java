...
@ApiResponses({
    @ApiResponse(responseCode = "200", description = "Successfully updates version for event type"),
    @ApiResponse(
        responseCode = "404",
    ...
    @ApiResponse(
        responseCode = "409",
        description = "Returns 409 when the version is not found",
        content = {
            @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = ApiErrorResponse.class),
...
public @interface UpdateEventTypeVersionsOperation {
}
