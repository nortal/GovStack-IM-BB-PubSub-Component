...
@ApiResponses({
    @ApiResponse(responseCode = "200", description = "Returns 200 when publisher is updated"),
    @ApiResponse(
        responseCode = "404",
        description = "Returns 404 when manager, room, publisher or event type is not found",
        content = {
            @Content(
...
public @interface UpdatePublisherOperation {
}
